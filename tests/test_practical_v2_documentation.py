...
class PracticalV2DocumentationTests(unittest.TestCase):
    ...
    def test_20c_readme_indexes_algorithm_ml_evidence_without_overclaiming(self) -> None:
        for phrase in [
            ...
            "value-profile identifier detector",
            "data/experiments/schema_matching_identifier_role_v1/README.md",
            "aggregate source column values",
            "without using source headers, target identity, scenario identity, or ground-truth-derived ranking features",
            "107 development fields",
            "36 identifier and 71 non-identifier",
            "balanced accuracy 0.8326",
            "ROC-AUC 0.9163",
            "AP 0.8883",
            "development-only evidence rather than a production promotion",
            "src/core/mapping/identifier_role_detection.py",
            "identifier-role ranking ablation",
            "data/experiments/schema_matching_identifier_role_ranking_ablation_v1/README.md",
            "nested leave-one-contract-family-out evaluation",
            "inner grouped out-of-fold predictions",
            "alpha=0",
            "V5, heuristic, learned, and oracle systems had identical pooled ranking metrics",
            "improved/regressed cases at 0/0",
            "even the oracle role signal produced no ranking lift",
            "no evidence to connect this signal to V5 or runtime",
            "src/core/mapping/identifier_role_reranker.py",
